...
The formula that this function uses to calculate standard deviation is:

$$\sigma = \sqrt{\sum\limits_{i=1}^n \frac{(\bar{x}-x_i)^2}{n}}$$

Where $n$ is the size of the set of numbers, $\bar{x}$ is the average of the numbers in the set, and $x_i$ denotes the $i$th element in the set.
